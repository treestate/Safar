...
(function ($) {
    ...
    $.fn.BootSideMenu = function (userOptions) {
        ...
        newCode += "	<span class=\"fa\"></span> <span class=\"toggleBtn\"><span class='hideHelp'><i class='fa fa-close'> </i></span><span>H </span>  <span>E</span> <span>L</span> <span>P</span>  </span>";
        newCode += "</div>";
        ...
        menu.addClass("leftPanel");
        menu.css("width", options.width);

        if (options.side == "left") {
            menu.addClass("leftPanel-left");
        } else if (options.side == "right") {
            menu.addClass("leftPanel-right");
        }
        ...
        function switchArrow(side) {
            var span = menu.toggler.find("span.fa");
            if (side == "left") {
